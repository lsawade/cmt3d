...
from cmt3d.ioi.functions.utils import downloaddir
from cmt3d.ioi.functions.get_data_mpi import get_data_mpi
from cmt3d.ioi.functions.events import check_events_todownload


def split(sequence: tp.Sequence, count: int):
    """
