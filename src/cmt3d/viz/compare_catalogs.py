...
class CompareCatalogs:
    ...
    def plot_cmts(self, legend=True):
        ...
        def sizefunc(x): return np.pi*(0.4*(x-minm)/(maxm-minm) + 1)**8 + 8
    ...
    def plot_eps_nu(self):
        ...
        utils.plot_label(ax, label, location=2, box=False,
                        fontdict=dict(fontsize='xx-small', fontfamily="monospace"))
        utils.plot_label(ax, "CLVD-", location=6, box=False,
                        fontdict=dict(fontsize='small'))
        utils.plot_label(ax, "CLVD+", location=7, box=False,
                        fontdict=dict(fontsize='small'))
        utils.plot_label(ax, "DC", location=14, box=False,
                        fontdict=dict(fontsize='small'))
    ...
    def plot_depth_v_eps_nu(self, outfile=None):
        ...
        # Plot clvd labels
        utils.plot_label(axscatter, "CLVD-", location=11, box=False,
                        fontdict=dict(fontsize='small'))
        utils.plot_label(axscatter, "CLVD+", location=10, box=False,
                        fontdict=dict(fontsize='small'))
        utils.plot_label(axscatter, "DC", location=16, box=False,
                        fontdict=dict(fontsize='small'))
